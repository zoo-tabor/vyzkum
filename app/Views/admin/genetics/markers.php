...
<div class="card">
    ...
    <form method="post" action="/admin/genetics/genes" class="form-row">
        ...
        <div><label for="name">Nazev</label><input type="text" id="name" name="name"></div>
        <div class="form-row__action"><button type="submit" class="btn btn--primary">Pridat gen</button></div>
    </form>
    <table class="table">
        <thead><tr><th>Symbol</th><th>Nazev</th><th>Markeru</th></tr></thead>
        <tbody>
...
<div class="card">
    <h2>Novy marker</h2>
    <?php if ($genes === []): ?>
        <p class="muted">Nejdrive zalozte gen.</p>
    <?php else: ?>
        <form method="post" action="/admin/genetics/markers">
            ...
            <div class="form-row">
                ...
                <div><label for="marker_code">Kod markeru *</label><input type="text" id="marker_code" name="marker_code" placeholder="napr. B3GALNT1" required></div>
            ...
            <div class="form-row">
                ...
                <div><label for="allowed_values">Povolene hodnoty</label><input type="text" id="allowed_values" name="allowed_values" placeholder="GG,GC,CC"></div>
            </div>
            <button type="submit" class="btn btn--primary">Pridat marker</button>
        </form>
    <?php endif; ?>

    <table class="table" style="margin-top:1rem">
        <thead><tr><th>Marker</th><th>Gen</th><th>Lokus</th><th>Ref/Alt</th><th>Povolene</th></tr></thead>
        <tbody>
