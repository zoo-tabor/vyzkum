...
?>
<div class="page-head">
    <h1>Upravit vzorek <code><?= e($sid) ?></code></h1>
    <p><a href="/admin/samples/<?= e(rawurlencode($sid)) ?>">&larr; Zpět na vzorek</a></p>
</div>
...
<div class="card">
    <form method="post" action="/admin/samples/<?= e(rawurlencode($sid)) ?>/edit">
        ...
        <a class="btn" href="/admin/samples/<?= e(rawurlencode($sid)) ?>">Zrušit</a>
    </form>
</div>
