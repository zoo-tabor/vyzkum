...
<div class="card">
    <?php if ($batches === []): ?>
        <p class="muted">Zatim zadne davky.</p>
    <?php else: ?>
        <table class="table">
            <thead><tr><th>#</th><th>Popis</th><th>Plemeno</th><th>Veterinar</th><th>Sad</th><th>Vytvoreno</th><th></th></tr></thead>
            <tbody>
            <?php foreach ($batches as $b): ?>
                <tr>
                    ...
                    <td><a href="/admin/batches/<?= (int) $b['id'] ?>/labels" target="_blank">Tisk stitku</a></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>
